...
public class PyramidPanel extends JPanel {
        ...
        private int checkLeft(Vertex mid){
        	int win = 0;
        	if(mid.getPlayer() != 0){
        		if(mid.getPlayer() == mid.getLeft().getPlayer() && mid.getPlayer() == mid.getLeft().getLeft().getPlayer()){
        ...
        private int checkWin(){
        	...
        	for (int x = 0; x < gridCols; x++){
        		if(grid[0][x].getPlayer() == 1){
        			if(grid[0][x].getPlayer() == grid[0][x].getAbove().getPlayer() && grid[0][x].getPlayer() == grid[0][x].getAbove().getAbove().getPlayer()){
